...
wright:     file format elf64-x86-64
...
0000000000001050 <write@plt>:
    ...
    1054:	f2 ff 25 75 2f 00 00 	bnd jmp *0x2f75(%rip)        # 3fd0 <write@GLIBC_2.2.5>
