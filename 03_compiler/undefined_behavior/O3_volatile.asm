...
ub_O3_volatile:     file format elf64-x86-64
...
0000000000001060 <main>:
    ...
    1068:	8b 44 24 0c          	mov    0xc(%rsp),%eax
    106c:	85 c0                	test   %eax,%eax
    106e:	74 07                	je     1077 <main+0x17>
    1070:	31 c0                	xor    %eax,%eax
    1072:	48 83 c4 18          	add    $0x18,%rsp
    1076:	c3                   	ret    
    1077:	48 8d 3d 86 0f 00 00 	lea    0xf86(%rip),%rdi        # 2004 <_IO_stdin_used+0x4>
    107e:	e8 cd ff ff ff       	call   1050 <puts@plt>
    1083:	eb eb                	jmp    1070 <main+0x10>
