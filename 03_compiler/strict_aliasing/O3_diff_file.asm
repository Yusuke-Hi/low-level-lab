...
sa_diff_file_O3:     file format elf64-x86-64
...
0000000000001080 <main>:
    ...
    109d:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%rsp)
    10a4:	00 
    10a5:	48 89 fe             	mov    %rdi,%rsi
    10a8:	e8 23 01 00 00       	call   11d0 <_Z1fPiPf>
    10ad:	48 8d 35 50 0f 00 00 	lea    0xf50(%rip),%rsi        # 2004 <_IO_stdin_used+0x4>
    10b4:	bf 01 00 00 00       	mov    $0x1,%edi
    10b9:	89 c2                	mov    %eax,%edx
    10bb:	31 c0                	xor    %eax,%eax
    10bd:	e8 ae ff ff ff       	call   1070 <__printf_chk@plt>
    10c2:	48 8b 44 24 08       	mov    0x8(%rsp),%rax
    10c7:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    10ce:	00 00 
    10d0:	75 07                	jne    10d9 <main+0x59>
    10d2:	31 c0                	xor    %eax,%eax
    10d4:	48 83 c4 18          	add    $0x18,%rsp
    10d8:	c3                   	ret    
    10d9:	e8 82 ff ff ff       	call   1060 <__stack_chk_fail@plt>
...
00000000000011d0 <_Z1fPiPf>:
    11d0:	f3 0f 1e fa          	endbr64 
    11d4:	c7 06 00 00 80 3f    	movl   $0x3f800000,(%rsi)
    11da:	8b 07                	mov    (%rdi),%eax
    11dc:	c3                   	ret    
