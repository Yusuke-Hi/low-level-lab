...
sa_O0:     file format elf64-x86-64
...
0000000000001169 <main>:
    ...
    1184:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%rbp)
    118b:	48 8d 45 ec          	lea    -0x14(%rbp),%rax
    118f:	48 89 45 f0          	mov    %rax,-0x10(%rbp)
    1193:	48 8b 45 f0          	mov    -0x10(%rbp),%rax
    1197:	f3 0f 10 05 71 0e 00 	movss  0xe71(%rip),%xmm0        # 2010 <_IO_stdin_used+0x10>
    119e:	00 
    119f:	f3 0f 11 00          	movss  %xmm0,(%rax)
    11a3:	8b 45 ec             	mov    -0x14(%rbp),%eax
    11a6:	85 c0                	test   %eax,%eax
    11a8:	75 0f                	jne    11b9 <main+0x50>
    11aa:	48 8d 05 53 0e 00 00 	lea    0xe53(%rip),%rax        # 2004 <_IO_stdin_used+0x4>
    11b1:	48 89 c7             	mov    %rax,%rdi
    11b4:	e8 a7 fe ff ff       	call   1060 <puts@plt>
    11b9:	b8 00 00 00 00       	mov    $0x0,%eax
    11be:	48 8b 55 f8          	mov    -0x8(%rbp),%rdx
    11c2:	64 48 2b 14 25 28 00 	sub    %fs:0x28,%rdx
    11c9:	00 00 
    11cb:	74 05                	je     11d2 <main+0x69>
    11cd:	e8 9e fe ff ff       	call   1070 <__stack_chk_fail@plt>
    11d2:	c9                   	leave  
    11d3:	c3                   	ret    
