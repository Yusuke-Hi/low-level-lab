...
sa2_O0:     file format elf64-x86-64
...
0000000000001080 <_start>:
    ...
    1098:	48 8d 3d f2 00 00 00 	lea    0xf2(%rip),%rdi        # 1191 <main>
...
0000000000001169 <_Z1fPiPf>:
    1169:	f3 0f 1e fa          	endbr64 
    116d:	55                   	push   %rbp
    116e:	48 89 e5             	mov    %rsp,%rbp
    1171:	48 89 7d f8          	mov    %rdi,-0x8(%rbp)
    1175:	48 89 75 f0          	mov    %rsi,-0x10(%rbp)
    1179:	48 8b 45 f0          	mov    -0x10(%rbp),%rax
    117d:	f3 0f 10 05 83 0e 00 	movss  0xe83(%rip),%xmm0        # 2008 <_IO_stdin_used+0x8>
    1184:	00 
    1185:	f3 0f 11 00          	movss  %xmm0,(%rax)
    1189:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
    118d:	8b 00                	mov    (%rax),%eax
    118f:	5d                   	pop    %rbp
    1190:	c3                   	ret    
...
0000000000001191 <main>:
    ...
    11ac:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%rbp)
    11b3:	48 8d 55 f4          	lea    -0xc(%rbp),%rdx
    11b7:	48 8d 45 f4          	lea    -0xc(%rbp),%rax
    11bb:	48 89 d6             	mov    %rdx,%rsi
    11be:	48 89 c7             	mov    %rax,%rdi
    11c1:	e8 a3 ff ff ff       	call   1169 <_Z1fPiPf>
    ...
    11e1:	48 8b 55 f8          	mov    -0x8(%rbp),%rdx
    11e5:	64 48 2b 14 25 28 00 	sub    %fs:0x28,%rdx
    11ec:	00 00 
    11ee:	74 05                	je     11f5 <main+0x64>
    11f0:	e8 6b fe ff ff       	call   1060 <__stack_chk_fail@plt>
    11f5:	c9                   	leave  
    11f6:	c3                   	ret    
